...
_Centre de documentation technique et fonctionnelle_
...
- [📋 Architecture & Modules Overview](./ARCHITECTURE_OVERVIEW.md) - _Pour Chefs de Projet Data / Product Owners_
  - Vue d'ensemble de l'architecture
  - Organisation du dépôt
  - Description des modules fonctionnels
  - Flux de données et dépendances
  - Points clés pour la data
- [📁 Technical Details (Annexe)](./TECHNICAL_DETAILS.md) - _Fichiers sources + Tests_
