...
La roadmap mentionne : _"Les endpoints qui dépendent d'un utilisateur — fn_progress_serie (vue datée par saison) et fn_episodes_non_vus (calendrier) — sont logiquement de la Phase 4"_.
