...
_Documentation synthétique à destination des Chefs de Projet Data / Product Owners_
...
📌 _Pour les détails techniques (fichiers sources, tests) : voir [TECHNICAL_DETAILS.md](./TECHNICAL_DETAILS.md)_
...
> _Application web qui consomme l'API backend eMDB_
...
_Document généré à partir de la roadmap et de l'analyse du code._
_Pour plus de détails : voir [emdb_roadmap_backend.md](../emdb_roadmap_backend.md)_
